...
class PengajuanCicilan extends Model
{
    ...
    /**
     * Get the pengajuan peminjaman that this restrukturisasi belongs to.
     */
    ...
    /**
     * Alias for pengajuanTagihanPinjaman.
     */
    public function tagihanPinjaman()
    {
        return $this->pengajuanTagihanPinjaman();
    }
    ...
    {
        return $this->hasMany(HistoryStatusPengajuanRestrukturisasi::class, 'id_pengajuan_restrukturisasi', 'id_pengajuan_restrukturisasi');
    }
    ...
    {
        return $this->hasOne(PenyesuaianCicilan::class, 'id_pengajuan_restrukturisasi', 'id_pengajuan_restrukturisasi');
    }
