...
class ArPerbulanFinlog extends Model
{
    use HasFactory, HasUlids, SoftDeletes;

    protected $table = 'ar_perbulan_finlog';
    protected $primaryKey = 'id_ar_perbulan_finlog';
    ...
    protected $casts = [
        ...
        'total_pengembalian_bunga' => 'decimal:2',
    ...
    /**
     * Relasi ke MasterDebiturDanInvestor
     */
