...
class PenyaluranDanaInvestasi extends Model
{
    ...
    protected $table = 'penyaluran_dana_investasi';

    protected $primaryKey = 'id_penyaluran_dana_investasi';
    ...
    {
        return $this->hasMany(RiwayatPengembalianDanaInvestasi::class, 'id_penyaluran_dana_investasi', 'id_penyaluran_dana_investasi');
    }
