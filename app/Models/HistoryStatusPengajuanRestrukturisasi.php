...
class HistoryStatusPengajuanRestrukturisasi extends Model
{
     ...
     */
    protected $table = 'history_status_pengajuan_restrukturisasi';
    
    /**
     * The primary key associated with the table.
     */
    protected $primaryKey = 'id_history_status_restrukturisasi';
