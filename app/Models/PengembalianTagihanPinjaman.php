...
class PengembalianTagihanPinjaman extends Model
{
    use HasFactory, HasUlids;

    protected $table = 'pengembalian_tagihan_pinjaman';
    ...
    {
        return $this->hasMany(LaporanPengembalian::class, 'id_pengembalian', 'ulid');
    }
}
