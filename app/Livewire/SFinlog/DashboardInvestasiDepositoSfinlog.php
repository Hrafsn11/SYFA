...
class DashboardInvestasiDepositoSfinlog extends Component
{
    ...
    protected DashboardInvestasiDepositoSfinlogService $service;

    public function boot(DashboardInvestasiDepositoSfinlogService $service): void
    {
    ...
    public function render()
    {
        ...
        return view('livewire.sfinlog.dashboard-investasi-deposito', [
            'summaryData' => $summaryData,
            'chartData' => $chartData,
            'monthOptions' => $this->service->getMonthOptions(),
        ])->layout('layouts.app', [
            'title' => 'Dashboard Investasi Deposito SFinlog'
        ]);
    }
}
