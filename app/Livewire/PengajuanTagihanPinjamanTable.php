...
class PengajuanTagihanPinjamanTable extends DataTableComponent
{
    use HasDebiturAuthorization;

    protected $model = PengajuanTagihanPinjaman::class;

    protected $listeners = ['refreshPengajuanTagihanPinjamanTable' => '$refresh'];

    public function configure(): void
    {
        $this->setPrimaryKey('id_pengajuan_peminjaman')
            ->setSearchEnabled()
            ->setSearchPlaceholder('Cari pengajuan tagihan pinjaman...')
            ...
            ->setDefaultSort('pengajuan_tagihan_pinjaman.created_at', 'desc')
            ...
            ->setSearchFieldAttributes([
                'class' => 'form-control',
                'placeholder' => 'Cari pengajuan tagihan pinjaman...',
            ])
    ...
    {
        $query = PengajuanTagihanPinjaman::query()
            ->with(['debitur', 'instansi', 'historyStatus'])
            ->leftJoin('master_debitur_dan_investor', 'pengajuan_tagihan_pinjaman.id_debitur', '=', 'master_debitur_dan_investor.id_debitur')
            ->select(
                'pengajuan_tagihan_pinjaman.*',
                DB::raw('master_debitur_dan_investor.nama as nama_perusahaan')
            )
            ->orderBy('pengajuan_tagihan_pinjaman.created_at', 'desc');
