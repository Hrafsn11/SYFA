...
class GenerateKontrak extends Component
{
    ...
    public function mount(string $id): void
    {
        ...
        if ($this->program->kontrak_generated_at) {
            redirect()->route('program-restrukturisasi.show', $this->program->id_program_restrukturisasi)->send();
            return;
        }
    ...
    public function generateKontrak()
    {
        ...
        try {
            ...
            $this->dispatch('swal:modal', [
                ...
                'redirect_url' => route('program-restrukturisasi.show', $this->program->id_program_restrukturisasi),
            ]);
    ...
    {
        return view('livewire.program-restrukturisasi.generate-kontrak');
    }
