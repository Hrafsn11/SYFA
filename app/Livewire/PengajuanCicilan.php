...
class PengajuanCicilan extends Component
{
    use HasUniversalFormAction, HasValidate, WithFileUploads;

    private string $validateClass = PengajuanCicilanRequest::class;
    ...
    #[FieldInput]
    public $tunggakan_pokok, $tunggakan_bunga, $jatuh_tempo_terakhir, $status_dpd, $alasan_restrukturisasi;
    ...
    public function mount()
    {
        ...
        $this->setUrlSaveData('store_restrukturisasi', 'pengajuan-cicilan.store', ['callback' => 'afterAction']);
        $this->setUrlSaveData('update_restrukturisasi', 'pengajuan-cicilan.update', ['id' => 'id_placeholder', 'callback' => 'afterAction']);
    ...
    public function loadPeminjamanData()
    {
        ...
        if ($this->id_debitur) {
            $this->peminjamanList = PengajuanTagihanPinjaman::where('id_debitur', $this->id_debitur)
    ...
    public function loadPengajuanData($id)
    {
        ...
        if ($id) {
            $pengajuan = PengajuanTagihanPinjaman::find($id);
            ...
            if ($pengajuan) {
                ...
                $pengembalianTerakhir = PengembalianTagihanPinjaman::where('id_pengajuan_peminjaman', $pengajuan->id_pengajuan_peminjaman)
    ...
    {
        return view('livewire.pengajuan-cicilan.index')
            ->layout('layouts.app', [
