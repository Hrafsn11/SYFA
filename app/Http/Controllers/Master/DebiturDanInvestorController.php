    ...
    public function edit($id)
    {
        ...
        if ($debitur->flagging == 'ya') {
            ...
            $result = [
                ...
                'email_ceo' => $debitur->email_ceo,
                'nama_direktur_holding' => $debitur->nama_direktur_holding,
                'email_direktur_holding' => $debitur->email_direktur_holding,
                'nama_komisaris' => $debitur->nama_komisaris,
                'email_komisaris' => $debitur->email_komisaris,
                'alamat' => $debitur->alamat,
                'email' => $debitur->email,
                'no_telepon' => $debitur->no_telepon,
                'nama_bank' => $debitur->nama_bank,
