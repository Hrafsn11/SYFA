...
class PengembalianPinjamanRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'total_bagi_hasil.required' => 'Total bagi hasil harus diisi.',
            'total_bagi_hasil.numeric' => 'Total bagi hasil harus berupa angka.',
            ...
            'sisa_bagi_hasil.required' => 'Sisa bagi hasil harus diisi.',
