...
class PenyesuaianCicilanRequest extends FormRequest
{
    ...
    {
        return [
            'id_pengajuan_cicilan.required' => 'Silakan pilih pengajuan restrukturisasi terlebih dahulu.',
            'id_pengajuan_cicilan.exists' => 'Pengajuan restrukturisasi tidak valid.',
    ...
    {
        return [
            'id_pengajuan_cicilan' => 'pengajuan restrukturisasi',
