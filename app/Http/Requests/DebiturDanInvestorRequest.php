...
class DebiturDanInvestorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $validate = [
            ...
            'kode_perusahaan' => 'required|min:2|max:4|regex:/^[A-Za-z0-9]+$/|unique:master_debitur_dan_investor,kode_perusahaan',
            ...
            'email_ceo' => 'nullable|email|max:255',
            'nama_direktur_holding' => 'required_if:flagging,tidak|max:255',
            'email_direktur_holding' => 'nullable|email|max:255',
            'nama_komisaris' => 'required_if:flagging,tidak|max:255',
            'email_komisaris' => 'nullable|email|max:255',
        ...
        if ($this->id) {
            ...
            $validate['kode_perusahaan'] = 'required|min:2|max:4|regex:/^[A-Za-z0-9]+$/|unique:master_debitur_dan_investor,kode_perusahaan,' . $this->id . ',id_debitur';
    ...
    public function messages()
    {
        return [
            ...
            'email_ceo.email' => 'Email CEO tidak valid.',
            'email_ceo.max' => 'Email CEO tidak boleh lebih dari 255 karakter.',
            'nama_direktur_holding.required_if' => 'Nama Direktur Holding harus diisi.',
            'nama_direktur_holding.max' => 'Nama Direktur Holding tidak boleh lebih dari 255 karakter.',
            'email_direktur_holding.email' => 'Email Direktur Holding tidak valid.',
            'email_direktur_holding.max' => 'Email Direktur Holding tidak boleh lebih dari 255 karakter.',
            'nama_komisaris.required_if' => 'Nama Komisaris harus diisi.',
            'nama_komisaris.max' => 'Nama Komisaris tidak boleh lebih dari 255 karakter.',
            'email_komisaris.email' => 'Email Komisaris tidak valid.',
            'email_komisaris.max' => 'Email Komisaris tidak boleh lebih dari 255 karakter.',
