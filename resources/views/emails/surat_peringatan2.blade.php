...
<div class="container">
    ...
    <div class="content">
        ...
        <p>
            Bersama ini kami perlu informasikan Kembali bahwa tagihan tagihan pinjaman pembiayaan atas invoice no <strong>{{ $invoice }}</strong> sudah jatuh tempo <strong>91 hari</strong> dan telah kami ingatkan sebelumnya melalui Surat Peringatan ke-1 tertanggal {{ \Carbon\Carbon::now()->subDays(90)->format('d-m-Y') }}, namun hingga hari ini kami belum mendapatkan realisasi pembayaran tagihan pinjaman pembiayaan tersebut, untuk itu mohon kiranya dapat mengkonfirmasikan kepada Luthfia ke 0858 9246 7566 atau melalui email <strong><a href="mailto:luthfia@synnovac-capital.com">luthfia@synnovac-capital.com</a></strong> dan mengembalikan dana pembiayaan tersebut SEGERA kepada {{ $finance_finlog }} ke rekening nomor <strong>{{ $no_rek }} PT Synnovac Kapital Indonesia</strong>.
        </p>
        @php
            $textKol = '';
            if($kol == 0 || $kol == 1){
