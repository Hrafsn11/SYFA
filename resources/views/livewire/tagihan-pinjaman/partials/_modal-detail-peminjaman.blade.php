                    ...
                    <div class="modal-body">
                        ...
                        <div class="card border mb-3 shadow-none">
                            <div class="card-body">
                                ...
                                <!-- Total Bunga Disetujui & Persentase -->
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="totalBagiHasil" class="form-label">Total Bunga Disetujui (Auto)</label>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card border mb-3 shadow-none">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="editPersentaseBagiHasilDisetujui" class="form-label">Persentase Bunga yang Disetujui</label>
                                        <input type="text" class="form-control"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="editTotalBagiHasilDisetujui" class="form-label">Total Bunga Disetujui</label>
                                        @php
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card border mb-3 shadow-none">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="debiturPersentaseBagiHasilDisetujui" class="form-label">Persentase Bunga yang Disetujui</label>
                                        <input type="text" class="form-control"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="debiturTotalBagiHasilDisetujui" class="form-label">Total Bunga Disetujui</label>
                                        @php
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card border mb-3 shadow-none">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="ceoPersentaseBagiHasilDisetujui" class="form-label">Persentase Bunga yang Disetujui</label>
                                        <input type="text" class="form-control"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="ceoTotalBagiHasilDisetujui" class="form-label">Total Bunga Disetujui</label>
                                        @php
                                            $totalBagiHasilCEO = 0;
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card border mb-3 shadow-none">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="direkturPersentaseBagiHasilDisetujui" class="form-label">Persentase Bunga yang Disetujui</label>
                                        <input type="text" class="form-control"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="direkturTotalBagiHasilDisetujui" class="form-label">Total Bunga Disetujui</label>
                                        @php
