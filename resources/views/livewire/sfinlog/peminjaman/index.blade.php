            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-info mb-4" role="alert">
                        ...
                        Silakan download template dokumen NPA terlebih dahulu, isi dengan lengkap, kemudian upload saat pengajuan peminjaman dana.
                    </div>
    ...
    $(document).ready(function() {
        ...
        $('#btnOkeNPA').on('click', function() {
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    ...
                    $btn.prop('disabled', false).html('<i class="ti ti-check me-1"></i>Oke, Paham');
                }
            });
        });
        ...
        $('#tablePeminjamanDana').DataTable({
            ...
            columns: [
                ...
                { data: 'nominal_peminjaman', name: 'nominal_peminjaman' },
                { data: 'persentase_bagi_hasil', name: 'persentase_bagi_hasil' },
                { data: 'nominal_bagi_hasil', name: 'nominal_bagi_hasil' },
