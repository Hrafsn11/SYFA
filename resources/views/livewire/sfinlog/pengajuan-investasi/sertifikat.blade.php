...
<head>
    ...
    <title>Certificate of Financing - {{ $data['nomor_sertifikat'] }}</title>
    <style>
        @font-face {
...
<body>
    ...
    <div class="page">
        ...
        <!-- Title -->
        <div class="title">Certificate of Financing</div>

        <!-- Content -->
        <div class="content">
            <div class="content-row">
                <div class="content-label">NAMA PEMINJAM</div>
                <div class="content-separator">:</div>
                <div class="content-value">{{ $data['nama_peminjam'] }}</div>
            </div>
            <div class="content-row">
                <div class="content-label">NOMOR SERTIFIKAT</div>
                <div class="content-separator">:</div>
                <div class="content-value">{{ $data['nomor_sertifikat'] }}</div>
            </div>
            <div class="content-row">
            ...
            <div class="content-row">
                <div class="content-label">NILAI PINJAMAN</div>
                <div class="content-separator">:</div>
                <div class="content-value">{{ $data['nilai_pinjaman'] }}</div>
            </div>
            <div class="content-row">
    ...
    <div class="page">
        ...
        <div class="page2-content">
            ...
            <div class="page2-name">{{ $data['nama_peminjam'] }}</div>
            
            <div class="page2-message">
                telah menjadi mitra peminjaman S-Finlog dengan nilai {{ $data['nilai_pinjaman_text'] }}<br>
