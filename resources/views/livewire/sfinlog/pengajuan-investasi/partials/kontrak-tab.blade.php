                ...
                <form id="formGenerateKontrakFinlog">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" value="{{ $pengajuan->lama_investasi }} Bulan"
                                readonly>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label for="nomorKontrakFinlog" class="form-label">Nomor Kontrak <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="nomorKontrakFinlog" name="nomor_kontrak"
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#btnPreviewKontrakFinlog').click(function() {
                    ...
                    const previewUrl =
                        `/sfinlog/pengajuan-investasi/${pengajuanId}/preview-kontrak?nomor_kontrak=${encodeURIComponent(nomorKontrak)}`;
