...
@if ($currentStep == 7)
<button type="button" class="btn btn-primary" wire:click="uploadDokumenTransfer"
    wire:loading.attr="disabled">
    <span wire:loading.remove wire:target="uploadDokumenTransfer">
        <i class="fas fa-upload me-2"></i>
        Upload Bukti Transfer
    </span>
    <span wire:loading wire:target="uploadDokumenTransfer">
