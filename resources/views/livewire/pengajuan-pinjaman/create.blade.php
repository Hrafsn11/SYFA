                        ...
                        <div id="formNonInstallment">
                            ...
                            <div class="row">
                                <div class="col-md-4 form-group mb-3">
                                    <label for="total_bunga" class="form-label">Total Bunga</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control input-rupiah non-editable" id="total_bunga" wire:model="total_bunga" placeholder="2%" readonly disabled>
                                        <span class="input-group-text">/Bulan</span>
                                    </div>
                                    <div class="invalid-feedback"></div>
                                </div>
