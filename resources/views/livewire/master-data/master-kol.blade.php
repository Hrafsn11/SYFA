                ...
                <form wire:submit='saveData("master-data.kol.store", @json(["callback" => "afterAction"]))'>
                    <div class="modal-body">
                        <div class="mb-3 form-group">
                            ...
                            <input type="text" class="form-control" id="kol" placeholder="Masukkan KOL" wire:model="form_data.kol">
                        ...
                        <div class="mb-3 form-group">
                            ...
                            <input type="text" class="form-control" id="persentase_keterlambatan" placeholder="Masukkan Persentase Pencairan" wire:model="form_data.persentase_pencairan">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="mb-3 form-group">
                            ...
                            <input type="text" class="form-control" id="tanggal_tenggat" placeholder="Masukkan Jumlah Hari Keterlambatan" wire:model="form_data.jmlh_hari_keterlambatan">
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
