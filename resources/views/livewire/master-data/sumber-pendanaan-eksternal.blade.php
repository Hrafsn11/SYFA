            ...
            <div class="mb-4 d-flex justify-content-between align-items-center">
                ...
                @can('master_data.add')
                    <button type="button" class="btn btn-primary d-flex justify-content-center align-items-center gap-3"
                        data-bs-toggle="modal" data-bs-target="#modalTambahSumberPendanaan" id="btnTambahSumberPendanaan">
                ...
                <form wire:submit='{{ $urlAction['store_pendanaan'] }}'>
                    <div class="modal-body">
                        <div class="mb-3 form-group">
                            <label for="nama_instansi" class="form-label">Nama Instansi <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="nama_instansi"
                                placeholder="Masukkan nama instansi" wire:model.blur="nama_instansi">
...
@push('scripts')
    <script>
        ...
        function editData(payload) {
            ...
            form.attr('wire:submit', `{!! $urlAction['update_pendanaan'] !!}`.replace('id_placeholder', data.id_instansi));
        ...
        $(document).on('click', '.sumber-delete-btn', function(e) {
            ...
            sweetAlertConfirm({
                ...
                @this.saveData("master-data.sumber-pendanaan-eksternal.destroy", {
                    "id": id,
