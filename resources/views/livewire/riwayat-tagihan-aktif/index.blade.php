<div>
    <div class="row mb-4 align-items-center">
        <div class="col-md-6">
            <h4 class="fw-bold mb-0">Debitur Tagihan Pinjaman</h4>
            <p class="text-muted mb-0">Data tagihan pinjaman debitur dan riwayat pembayaran</p>
        </div>
    ...
    <div class="card">
        <div class="card-datatable table-responsive">
            <livewire:debitur-tagihan pinjaman-sfinance />
        </div>
    </div>

    {{-- Modal Edit Debitur Tagihan Pinjaman --}}
    @can('debitur_tagihan pinjaman.edit')
        <div class="modal fade" id="editDebiturTagihan PinjamanModal" tabindex="-1" aria-labelledby="editDebiturTagihan PinjamanModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editDebiturTagihan PinjamanModalLabel">Edit Debitur Tagihan Pinjaman</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form id="editDebiturTagihan PinjamanForm">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="edit_persentase_bagi_hasil" class="form-label">% Bunga</label>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" id="saveDebiturTagihan PinjamanBtn">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const modal = document.getElementById('editDebiturTagihan PinjamanModal');
            if (!modal) return;
            ...
            document.addEventListener('click', function(e) {
                const btn = e.target.closest('.edit-debitur-tagihan pinjaman-btn');
                if (!btn) return;
            ...
            // Handle form submit
            document.getElementById('editDebiturTagihan PinjamanForm').addEventListener('submit', function(e) {
                e.preventDefault();

                const saveBtn = document.getElementById('saveDebiturTagihan PinjamanBtn');
                ...
                fetch('{{ route('debitur-tagihan pinjaman.update') }}', {
                        method: 'POST',
                        headers: {
