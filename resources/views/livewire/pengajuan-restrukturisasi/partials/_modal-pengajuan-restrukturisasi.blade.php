                     ...
                     <div class="bs-stepper-content">
                         <form id="formRestrukturisasi" wire:submit="saveData">
                             ...
                             <div id="stepDataPeminjaman" class="content">
                                 ...
                                 <div class="row g-6 px-4 pb-4">
                                     ...
                                     <div class="col-md-6 form-group">
                                         ...
                                         <input type="text" class="form-control" id="jabatan_pic"
                                             name="jabatan_pic">
                                     </div>
                                 ...
                                 <div class="row g-6 px-4 pb-4">
                                     ...
                                     <div class="col-md-6 form-group">
                                         ...
                                         <div class="input-group">
                                             <input type="text" class="form-control bs-datepicker"
                                                 id="tanggal_akad" name="tanggal_akad" wire:model.blur="tanggal_akad"
                                             ...
                                             <div class="col-sm">
                                                 <div class="form-check custom-option custom-option-basic">
                                                     <label class="form-check-label custom-option-content"
                                                         ...
                                                         <input name="customRadioTemp" class="form-check-input"
                                                             type="radio" value="" id="customRadioTemp3" />
                                                         <span class="custom-option-header">
                                             ...
                                             <div class="col-sm">
                                                 <div class="form-check custom-option custom-option-basic">
                                                     <label class="form-check-label custom-option-content"
                                                         ...
                                                         <input name="customRadioTemp" class="form-check-input"
                                                             type="radio" value="" id="customRadioTemp4" />
                                                         <span class="custom-option-header">
                                     ...
                                     <div class="col-md-6 form-group">
                                         <label for="tunggakan_pokok" class="form-label">Tunggakan Pokok (jika
                                             ada)</label>
                                         <input type="text" class="form-control input-rupiah" id="tunggakan_pokok"
                                     ...
                                     <div class="col-md-6 form-group">
                                         ...
                                         <div class="input-group">
                                             <input type="text" class="form-control bs-datepicker"
                                                 ...
                                                 wire:model.blur="jatuh_tempo_terakhir" placeholder="DD/MM/YYYY"
                                                 disabled>
                                             <span class="input-group-text"><i class="ti ti-calendar"></i></span>
                                         </div>
                                         <div class="invalid-feedback"></div>
                             ...
                             <div id="stepDokumen" class="content">
                                 ...
                                 <div class="row g-6 px-4 pb-4">
                                     <div class="col-12">
                                         <label for="permohonan_jenis_restrukturisasi" class="form-label">Permohonan
                                             Jenis Restrukturisasi <span class="text-danger">*</span></label>
                                         <div class="form-check mb-2">
                                             <input class="form-check-input" type="checkbox" name="opsi_restruktur[]"
                                                 value="suku_bunga" id="checkSukuBunga" />
                                         ...
                                         <div class="form-check mb-2">
                                             <input class="form-check-input" type="checkbox" name="opsi_restruktur[]"
                                                 value="jangka_waktu" id="checkJangkaWaktu" />
                                         ...
                                         <div class="form-check mb-2">
                                             <input class="form-check-input" type="checkbox" name="opsi_restruktur[]"
                                                 value="tunggakan" id="checkTunggakan" />
                                         ...
                                         <div class="form-check mb-2">
                                             <input class="form-check-input" type="checkbox" name="opsi_restruktur[]"
                                                 value="grace_period" id="checkGracePeriod" />
                                         ...
                                         <div class="form-check mb-3">
                                             <input class="form-check-input" type="checkbox" name="opsi_restruktur[]"
                                                 value="penjadwalan" id="checkPenjadwalan" />
                             ...
                             <div id="stepReview" class="content">
                                 ...
                                 <div class="row g-6 px-4 pb-4">
                                     ...
                                     <div class="col-md-6 form-group">
                                         ...
                                         <div class="input-group">
                                             <input type="file" class="form-control" id="fotocopy_ktp_pic"
                                                 name="fotocopy_ktp_pic" />
                                             <label class="input-group-text" for="fotocopy_ktp_pic">Upload</label>
                                         </div>
                                     </div>

                                     <div class="col-md-6 form-group">
                                         <label for="fotokopi_npwp_perusahaan" class="form-label">Fotokopi NPWP
                                             Perusahaan</label>
                                         <div class="input-group">
                                             <input type="file" class="form-control" id="fotokopi_npwp_perusahaan"
                                                 name="fotokopi_npwp_perusahaan" />
                                             <label class="input-group-text"
                                                 for="fotokopi_npwp_perusahaan">Upload</label>
                                         </div>
                                     </div>

                                     <div class="col-md-6 form-group">
                                         <label for="laporan_keuangan_terbaru" class="form-label">Laporan Keuangan
                                             Terbaru</label>
                                         <div class="input-group">
                                             <input type="file" class="form-control" id="laporan_keuangan_terbaru"
                                                 name="laporan_keuangan_terbaru" />
                                             <label class="input-group-text"
                                                 for="laporan_keuangan_terbaru">Upload</label>
                                         </div>
                                     </div>

                                     <div class="col-md-6 form-group">
                                         <label for="rekap_arus_kas" class="form-label">Rekap Arus Kas Proyeksi 6-12
                                             bulan</label>
                                         <div class="input-group">
                                             <input type="file" class="form-control" id="rekap_arus_kas"
                                                 name="rekap_arus_kas" />
                                     ...
                                     <div class="col-md-6 form-group">
                                         <label for="bukti_kondisi_eksternal" class="form-label">Bukti kondisi
                                             eksternal</label>
                                         <div class="input-group">
                                             <input type="file" class="form-control" id="bukti_kondisi_eksternal"
                                                 name="bukti_kondisi_eksternal" />
                                             <label class="input-group-text"
                                                 for="bukti_kondisi_eksternal">Upload</label>
                                         </div>
                                     </div>

                                     <div class="col-md-6 form-group">
                                         <label for="salinan_kontrak_pembiayaan" class="form-label">Salinan kontrak
                                             pembiayaan</label>
                                         <div class="input-group">
                                             <input type="file" class="form-control"
                                                 id="salinan_kontrak_pembiayaan" name="salinan_kontrak_pembiayaan" />
                                             <label class="input-group-text"
                                                 for="salinan_kontrak_pembiayaan">Upload</label>
                                         </div>
                                     </div>
                                     ...
                                     <div class="col-md-6 form-group">
                                         ...
                                         <div class="input-group">
                                             <input type="file" class="form-control" id="dokumen_lain"
                                                 name="dokumen_lain" />
                                     ...
                                     <div class="col-md-6 form-group">
                                         <label for="tanda_tangan_perusahaan" class="form-label">Tanda tangan
                                             Perusahaan</label>
                                         <div class="input-group">
                                             <input type="file" class="form-control" id="tanda_tangan_perusahaan"
                                                 name="tanda_tangan_perusahaan" />
                                             <label class="input-group-text"
                                                 for="tanda_tangan_perusahaan">Upload</label>
                                         </div>
                                     </div>
                                     ...
                                     <div class="col-md-6 form-group">
                                         ...
                                         <div class="input-group">
                                             <input type="text" class="form-control bs-datepicker" id="tanggal"
                                                 name="tanggal" wire:model.blur="tanggal" placeholder="DD/MM/YYYY">
                                             <span class="input-group-text"><i class="ti ti-calendar"></i></span>
                                         </div>
                                         <div class="invalid-feedback"></div>
                                     </div>
