<div class="d-flex justify-content-center align-items-center gap-2">
    <button class="btn btn-sm btn-icon btn-text-info rounded-pill waves-effect investor-detail-btn" type="button"
    ...
    @can('investasi.edit')
        @if ($status === 'Draft' || ($status === 'Ditolak' && $current_step == 1))
            <button class="btn btn-sm btn-icon btn-text-primary rounded-pill waves-effect investor-edit-btn" type="button"
