                                        ...
                                        <tr data-id="{{ $item->id_kol }}">
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center align-items-center gap-2">
                                                    <button class="btn btn-sm btn-icon btn-text-primary rounded-pill waves-effect btn-edit-kol"
                                                        title="Edit">
                                                        <i class="ti ti-edit"></i>
                                                    </button>
                                                    <button class="btn btn-sm btn-icon btn-text-danger rounded-pill waves-effect btn-delete-kol"
                                                        title="Hapus">
                    ...
                    <div class="modal-body">
                        <form id="formTambahKOL">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="kol" placeholder="Masukkan KOL"
                                    required min="1" step="1">
                            </div>
                            <div class="mb-3">
                                <label for="persentase_keterlambatan" class="form-label">Persentase Pencairan <span
                                        class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="persentase_keterlambatan"
                                    placeholder="Masukkan Persentase Pencairan" required min="0" max="100"
                                    step="1">
                            </div>
                            <div class="mb-3">
                                <label for="tanggal_tenggat" class="form-label">Jumlah Hari Keterlambatan <span
                                        class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="tanggal_tenggat"
                                    placeholder="Masukkan Jumlah Hari Keterlambatan" required min="0"
                                    step="1">
                            </div>
                        </form>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('btnSimpanKOL').addEventListener('click', function() {
            ...
            var kolData = {
                ...
                persentase_pencairan: parseFloat(document.getElementById('persentase_keterlambatan')
                    .value) || 0,
                jmlh_hari_keterlambatan: parseInt(document.getElementById('tanggal_tenggat')
                    .value) || 0,
            };
                ...
                if (res.success) {
                    ...
                    if (method === 'POST') {
                        ...
                        const row = document.querySelector(
                            `table.datatables-basic tbody tr[data-id="${d.id_kol}"]`);
                        if (row) {
            ...
            if (editBtn) {
                ...
                fetch('/master-data/kol/' + id + '/edit', {
                    ...
                    .then(res => {
                        ...
                        document.getElementById('persentase_keterlambatan').value = d
                            .persentase_pencairan;
                        document.getElementById('tanggal_tenggat').value = d
                        .jmlh_hari_keterlambatan;
