            ...
            <div class="card-body">
                <form action="{{ route('pengembalian.store') }}" method="POST" id="formPengembalian"
                    ...
                    <div class="card border-1 shadow-none mb-4">
                        <div class="card-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <label for="total_bagi_hasil">Total Bunga</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="sisa_bagi_hasil" class="form-label">Sisa Bunga</label>
...
@push('scripts')
    <script>
        ...
        function calculateSisa() {
            ...
            // Rumus: Pembayaran diprioritaskan ke bunga terlebih dahulu, baru ke pokok
