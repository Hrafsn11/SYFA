...
<div class="modal fade" id="modalPengembalianInvestasi" wire:ignore.self>
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <form id="formPengembalianInvestasi" wire:submit="{{ $urlAction['store_pengembalian_investasi'] ?? 'saveData' }}">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12 mb-3 form-group">
                            ...
                            <div wire:ignore>
                                <select id="id_pengajuan_investasi" class="form-select select2 @error('id_pengajuan_investasi') is-invalid @enderror" data-placeholder="Pilih No Kontrak">
                                    <option value=""></option>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" value="Rp {{ number_format($nominal_investasi ?? 0, 0, ',', '.') }}" readonly>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" value="Rp {{ number_format($bagi_hasil_total ?? 0, 0, ',', '.') }}" readonly>
                        </div>

                        @if($jumlah_transaksi > 0)
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Total Pokok Sudah Dikembalikan</label>
                                <input type="text" class="form-control text-success fw-bold" value="Rp {{ number_format($total_pokok_dikembalikan ?? 0, 0, ',', '.') }}" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Total Bagi Hasil Sudah Dikembalikan</label>
                                <input type="text" class="form-control text-success fw-bold" value="Rp {{ number_format($total_bagi_hasil_dikembalikan ?? 0, 0, ',', '.') }}" readonly>
                            </div>
                        @endif

                        <div class="col-md-6 mb-3">
                            <label class="form-label">Sisa Pokok</label>
                            <input type="text" class="form-control text-warning fw-bold" value="Rp {{ number_format($sisa_pokok ?? 0, 0, ',', '.') }}" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3 form-group">
                            ...
                            <div wire:loading wire:target="bukti_transfer" class="mt-1">
                                <small class="text-primary"><span class="spinner-border spinner-border-sm me-1"></span>Uploading...</small>
                            </div>
