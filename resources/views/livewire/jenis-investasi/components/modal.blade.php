<div>
{{-- Modal Tambah/Edit Penyaluran Jenis Investasi --}}
<div class="modal fade" id="modalPenyaluranJenis Investasi">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalPenyaluranJenis InvestasiLabel">Tambah Penyaluran Jenis Investasi</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <form id="formPenyaluranJenis Investasi" wire:submit="{{ $urlAction['store_penyaluran_jenis investasi'] }}">
