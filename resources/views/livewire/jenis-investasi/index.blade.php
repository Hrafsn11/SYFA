        ...
        <div class="row">
            <div class="col-12">
                <div class="mb-4 d-flex justify-content-between align-items-center">
                    ...
                    @can('penyaluran_jenis investasi.add')
                        <button type="button" class="btn btn-primary d-flex justify-content-center align-items-center gap-3"
                            id="btnTambahPenyaluran" data-bs-toggle="modal" data-bs-target="#modalPenyaluranJenis Investasi">
        ...
        <div class="card">
            <div class="card-body p-0">
                <div class="card-datatable">
                    <livewire:penyaluran-jenis investasi.penyaluran-jenis investasi-table />
                </div>
            </div>
        </div>

        @include('livewire.penyaluran-jenis investasi.components.modal')
...
@push('scripts')
    ...
    let nilaiInvestasiMax = 0;
        const canInputPengembalian = @json(auth()->user()->can('penyaluran_jenis investasi.input_pengembalian'));

        function afterAction(payload) {
            Livewire.dispatch('refreshPenyaluranJenis InvestasiTable');
            $('.modal').modal('hide');
        }
        ...
        $(document).ready(function () {
            ...
            $('#id_pengajuan_investasi').select2({
                dropdownParent: $('#modalPenyaluranJenis Investasi'),
                width: '100%',
            ...
            // Modal reset on hide
            $('#modalPenyaluranJenis Investasi').on('hidden.bs.modal', function () {
                $(this).find('form').attr('wire:submit', `{!! $urlAction['store_penyaluran_jenis investasi'] !!}`);
                $(this).find('.modal-title').text('Tambah Penyaluran Jenis Investasi');
        ...
        $(document).on('click', '#btnHapusData', function (e) {
            e.preventDefault();
            $('#modalPenyaluranJenis Investasi').modal('hide');
        ...
        $(document).on('click', '#btnConfirmDelete', function (e) {
            ...
            $.ajax({
                url: '{{ route('penyaluran-jenis investasi.destroy', ':id') }}'.replace(':id', currentIdForDelete),
                type: 'DELETE',
