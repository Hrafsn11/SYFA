...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <div class="card-body">
                <livewire:pengajuan-cicilan-table />
            </div>
        </div>

        {{-- Modal Restrukturisasi --}}
        @include('livewire.pengajuan-cicilan.partials._modal-pengajuan-cicilan')
    </div>
@endsection
...
@push('scripts')
    <script>
        ...
        function submitForm() {
            ...
            const url = editMode ?
                "{{ route('pengajuan-cicilan.update', ':id') }}".replace(':id', editId) :
                "{{ route('pengajuan-cicilan.store') }}";
        ...
        function loadPengajuanData(idPengajuan) {
            const url = "{{ route('pengajuan-cicilan.detail-pengajuan', ':id') }}".replace(':id', idPengajuan);
