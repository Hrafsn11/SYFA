@php
    ...
    $canEditDokumen = $isPerbaikanDokumen && $currentStep == 1 && auth()->user()->can('pengajuan_cicilan.ajukan_cicilan');
@endphp
...
<div class="tab-pane fade show active" id="detail-restrukturisasi" role="tabpanel">
    ...
    <div class="d-flex justify-content-between items-center mt-4 mb-3 mb-md-4 flex-wrap gap-2">
        ...
        <div class="d-flex gap-2 flex-wrap">
            ...
            @can('pengajuan_cicilan.ajukan_cicilan')
            ...
            {{-- Step 3: CEO Approval --}}
            @can('pengajuan_cicilan.persetujuan_ceo_ski')
                @if ($canApproveStep3)
            ...
            @can('pengajuan_cicilan.persetujuan_direktur')
                @if ($canApproveStep4)
    ...
    @if ($canEditDokumen)
        @include('livewire.pengajuan-cicilan.partials._dokumen-upload-form', [
            'pengajuan' => $pengajuan,
            'histories' => $histories,
    ...
    @if ($currentStep >= 2)
        @include('livewire.pengajuan-cicilan.partials._evaluasi-forms', ['evaluasi' => $evaluasi])
    @endif
</div>
