...
@section('content')
                ...
                <div class="card-body">
                    <div class="tab-content p-0">
                        ...
                        <div class="tab-pane fade show active" id="detail-restrukturisasi" role="tabpanel">
                            @include('livewire.pengajuan-cicilan.partials._detail-tab')
                        </div>

                        <!-- Activity Tab -->
                        <div class="tab-pane fade" id="activity-restrukturisasi" role="tabpanel">
                            @include('livewire.pengajuan-cicilan.partials._activity-tab')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const BASE_URL = '{{ route('sfinance.pengajuan-cicilan.show', ['id' => '__ID__']) }}'.replace('/__ID__', '');
            ...
            @php
                ...
                // Get evaluasi data
                $evaluasi = \App\Models\EvaluasiPengajuanCicilan::where('id_pengajuan_cicilan', $pengajuan->id_pengajuan_cicilan)->first();
