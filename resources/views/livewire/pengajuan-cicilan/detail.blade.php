...
@section('content')
    <div class="row">
        <div class="col-12">
            <h4 class="fw-bold mb-4">Detail Pengajuan Cicilan</h4>

            <!-- Stepper -->
            <div class="stepper-container mb-4">
                <div class="stepper-wrapper">
                    @foreach (['Pengajuan Cicilan', 'Evaluasi Dokumen', 'Persetujuan CEO', 'Persetujuan Direktur', 'Selesai'] as $i => $name)
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5 class="mb-2" id="approvalTitle">Apakah Anda yakin menyetujui pengajuan cicilan ini?</h5>
