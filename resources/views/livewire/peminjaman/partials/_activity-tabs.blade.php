                                    ...
                                    @php
                                        ...
                                        switch ($history->status) {
                                            ...
                                            case 'Menunggu Konfirmasi Debitur':
                                                ...
                                                $description =
                                                    'Bukti transfer telah diupload. Menunggu konfirmasi dari debitur.';
                                                break;
                        ...
                        <div class="col-6 col-md-3 text-end">
                            @if ($history->status == 'Generate Kontrak')
                                <button type="button" class="btn btn-icon btn-sm btn-label-primary"
                                    title="Preview Kontrak" onclick="previewKontrakActivity()">
                                    <i class="ti ti-file-text"></i>
                                </button>
                            @elseif($history->status == 'Menunggu Konfirmasi Debitur' && $peminjaman['upload_bukti_transfer'])
                                <button type="button" class="btn btn-icon btn-sm btn-label-primary"
                                    onclick="previewBuktiTransfer('{{ asset('storage/' . $peminjaman['upload_bukti_transfer']) }}')">
                                    <i class="ti ti-file-text"></i>
                                </button>
                            @elseif(
