                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="d-flex gap-3">
                                    <div class="form-check">
                                        <input name="flagging" class="form-check-input" type="radio" value="ya"
                                            id="flaggingYa" required>
                                        <label class="form-check-label" for="flaggingYa">Ya</label>
                                    </div>
                                    <div class="form-check">
                                        <input name="flagging" class="form-check-input" type="radio" value="tidak"
                                            id="flaggingTidak" required>
    ...
    <div class="modal fade" id="modalConfirmDeleteDebitur" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="mb-0">Apakah Anda yakin ingin menghapus Debitur/Investor ini? Tindakan ini tidak dapat
                        dibatalkan.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
